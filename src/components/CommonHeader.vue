...
<div>
  ...
  <header>
      <div class="wrapper">
        <el-row>
          <el-col :span="10">
            <div class="logo threed">面向交通标志的图像去雾算法的研究与实现</div>
          </el-col>
          <el-col :span="14">
            <!-- 导航菜单 -->
            ...
            class="nav">
              ...
              <el-menu-item index="5" @click="goToto">
                 <router-link to="/aboutMe" ><i class="iconfont icon-guanyuwomen"></i>关于我</router-link>
              </el-menu-item>
              ...
              <el-menu-item index="7"  @click="goToto">
                 <router-link to="/admin" v-if="isSignIn === 1 && isAdmin !== 0"><i class="iconfont My-new-iconwode1"></i>管理</router-link>
              </el-menu-item> -->
              <el-menu-item index="8" @click="goToto">
               ...
               <el-menu-item index="9"  @click="goToto">
                 <router-link to="/personal"  v-if="isSignIn === 1 "  class="login">{{isAdmin !== 0 ? '尊敬的管理员：' + UserInfo.nickname : '尊敬的会员：'+ UserInfo.nickname}}</router-link>
              </el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      ...
      <el-menu
          ...
          <el-submenu index="1">
            <template slot="title">
              ...
              <span class="logotit">面向交通标志的图像去雾算法的研究与实现</span>
              <span v-if="UserInfo.nickname">{{UserInfo.nickname}},欢迎您</span>
            </template>
            <el-menu-item-group>
              <el-menu-item index="/" @click="Goto"><i class="iconfont My-new-iconshouye"></i>首页</el-menu-item>
              <el-menu-item index="/Lists" @click="Goto"><i class="iconfont My-new-iconzixun"></i>水稻百科</el-menu-item>
               <el-menu-item index="/timeLocus" @click="Goto"><i class="iconfont My-new-icondaojishi"></i>历史记录</el-menu-item>
              <el-menu-item index="/recommend" @click="Goto"><i class="iconfont My-new-icondianzan"></i>智能识别</el-menu-item>
              ...
              <el-menu-item index="/personal" v-if="isSignIn === 1 && isAdmin === 1"> @click="Goto"><i class="iconfont My-new-iconwode1"></i>文章管理</el-menu-item>
...
header {
  background-color:#467fce;
  box-shadow: 1px 1px 1px 1px rgb(76, 183, 241);
  .logo {
  font-size: 18px;
  color: #fff;
  text-align: center;
